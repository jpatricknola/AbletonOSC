...
<!-- lom-gaps:begin -->
_Generated by `tools/lom_gaps.py` from a `/live/application/dump_lom` taken against Live 12.4.5. Do not edit by hand; rerun the tool. 134 Live classes and 0 Live modules walked, 786 fork addresses registered._

**Totals:** 287 members exposed, 412 gaps across 44 classes, plus 165 members across 31 entries in *Walked but not diffed* below.
...
### `Live.Base.Text` — 1 members (class)

_A translatable, immutable string._

- **ro:** `text`

### `Live.CcControlDevice.CcControlDevice.View` — 1 members (class)
...
_31 entries, 165 members, none reachable through any fork address._
