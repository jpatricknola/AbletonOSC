...
C-1 and C-2 could be merged if a PR is small.
...
| **D-5** Small leftovers | `TuningSystem`, `Song.tuning_system`, `Song.get_data`/`set_data`. Fold into C-1 if it is too small to stand alone. |
